...
--filter-tcp=443 --ipset="%LISTS%ipset-cloud.txt" --dpi-desync=fake,hostfakesplit --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=0 --dpi-desync-hostfakesplit-mod=altorder=1 --new ^
