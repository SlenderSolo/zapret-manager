...
--filter-tcp=443 --ipset="%LISTS%ipset-cloud.txt" --dpi-desync=fake,hostfakesplit --dpi-desync-fooling=md5sig --dpi-desync-fake-tls="%~dp0bin\tls_clienthello_www_google_com.bin" --new ^
