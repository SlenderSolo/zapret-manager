...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-split-pos=2,midsld --dpi-desync-fake-tls=0x00000000 --new ^
--filter-tcp=443 --hostlist="%LISTS%list-general.txt" --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-split-pos=2,midsld --dpi-desync-fake-tls=0x00000000 --new ^
--filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-split-pos=2,midsld --dpi-desync-fake-tls=0x00000000 --new ^
--filter-tcp=443 --ipset="%LISTS%ipset-all.txt" --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-split-pos=2,midsld --dpi-desync-fake-tls=0x00000000 --new ^
