...
--filter-tcp=443 %LST_YT% --ip-id=zero --dpi-desync=fake --dpi-desync-fooling=badseq --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
--filter-tcp=443 %LST_GEN% --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
--filter-tcp=443 %IP_ALL% --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
