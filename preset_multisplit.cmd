...
--filter-tcp=443 %LST_YT% --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=2 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls=0x00000000 %IP_EXC% %LST_EXC% --new ^
...
--filter-tcp=443 %IP_ALL% --dpi-desync=fake,multisplit --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=2 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" %IP_EXC% %LST_EXC% --new ^
