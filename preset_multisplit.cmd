...
--filter-tcp=443 %IP_ALL% --dpi-desync=fake,multisplit --dpi-desync-ttl=5 --dpi-desync-split-pos=midsld --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin" %IP_EXC% %LST_EXC% --new ^
