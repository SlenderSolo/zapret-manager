...
--filter-tcp=443 %LST_YT% --dpi-desync=fake,fakedsplit --dpi-desync-fooling=md5sig --dpi-desync-split-pos=midsld --dpi-desync-fake-tls=0x00000000 --dpi-desync-fake-tls=! --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
--filter-tcp=443 %LST_GEN% --ip-id=zero --dpi-desync=fake,fakedsplit --dpi-desync-fooling=md5sig --dpi-desync-split-pos=midsld --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
--filter-tcp=443 %IP_ALL% --ip-id=zero --dpi-desync=fake,fakedsplit --dpi-desync-fooling=md5sig --dpi-desync-split-pos=midsld --dpi-desync-fake-tls-mod=sni=www.google.com %IP_EXC% %LST_EXC% --new ^
